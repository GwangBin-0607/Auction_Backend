...
const { DTO_Product_Price_BeforePrice } = require('./DTO_Product_Price_BeforePrice');
const { DTO_Product_UpDown } = require('./DTO_Product_UpDown');
class DTO_Product_BeforePrice{
    /**
     * 
     ...
     * @param {DTO_Product_Price_BeforePrice} Product_Price 
     */
...
module.exports.DTO_Product_BeforePrice = DTO_Product_BeforePrice;